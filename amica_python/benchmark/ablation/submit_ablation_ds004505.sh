...
# amica_python to this checkout (the M>1-rejection branch) with --no-deps (no internet).
...
python -c "import sys, amica_python; print('amica_python', amica_python.__file__)"
