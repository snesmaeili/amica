...
Usage (Python)::
    ...
    from py_amica.benchmark.dipolarity import fit_ic_dipoles
...
def fit_ic_dipoles(
    ...
    *,
    ...
    for k in components:
        ...
        topo_full[info_subset_idx]  # match the picked channels
        try:
            evoked = _evoked_from_topomap(
                topo_full,
                info=info,
                sfreq=sfreq,
                picks_with_loc=picks_with_loc,
            )
            ...
            rows.append(
                ICDipoleFit(
                    ...
                    dipole_z=None,
                    gof=None,
                    residual_variance_percent=None,
                    ok=False,
                    error=str(exc),
                )
            )
